...
_G.packer_plugins = {
  ...
  ["dressing.nvim"] = {
    loaded = true,
    path = "/home/james/.local/share/nvim/site/pack/packer/start/dressing.nvim",
  ...
  ["no-clown-fiesta.nvim"] = {
    loaded = true,
    path = "/home/james/.local/share/nvim/site/pack/packer/start/no-clown-fiesta.nvim",
  ...
  onedark = {
    loaded = true,
    path = "/home/james/.local/share/nvim/site/pack/packer/start/onedark",
